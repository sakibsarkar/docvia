        ...
        <div className="mx-auto max-w-4xl space-y-8">
          ...
          <Card className="bg-glow-purple border-border/40 bg-card/50 p-8 backdrop-blur-sm">
            ...
            <p className="mt-4 ml-16 text-muted-foreground">
              Our AI processes this data only when a customer submits a query related to your
              chatbot.
            </p>
          </Card>
          ...
          <Card className="bg-glow-blue border-border/40 bg-card/50 p-8 backdrop-blur-sm">
            <div className="mb-4 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Docvia uses Google Gemini (gemini-1.5-flash) to process and understand the
                  selected documents.
                </p>
              </div>
            </div>
          ...
          <Card className="bg-glow-blue border-border/40 bg-card/50 p-8 backdrop-blur-sm">
            ...
            <ul className="ml-16 space-y-3">
              <li className="flex items-start gap-3">
                <div className="mt-2 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                <span className="text-foreground">
                  We do not permanently store your document content unless required for
                  functionality
                </span>
              </li>
              <li className="flex items-start gap-3">
