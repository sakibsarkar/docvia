...
const TermsAndConditionView = () => {
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="sticky top-0 z-50 border-b border-border/40 bg-card/30 backdrop-blur-xl">
      ...
      <section className="container mx-auto px-4 py-16 md:px-6 md:py-24 lg:px-8">
        <div className="mx-auto mb-16 max-w-4xl text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-balance text-muted-foreground">
            Welcome to Docvia. By accessing or using our website, application, or services, you
          ...
          <Card className="bg-glow-purple border-border/40 bg-card/50 p-8 backdrop-blur-sm">
            <div className="mb-4 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  You must be at least 13 years old (or the minimum legal age in your country) to
                  use Docvia. By using our services, you confirm that you meet this requirement.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-glow-blue border-border/40 bg-card/50 p-8 backdrop-blur-sm">
            ...
            <ul className="ml-16 space-y-3">
              ...
              <li className="flex items-start gap-3">
                <div className="mt-2 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                <span className="text-foreground">
                  Use of Google services is also subject to Google&apos;s Terms of Service and
                  Privacy Policy
                </span>
              </li>
            </ul>
          ...
          <Card className="bg-glow-blue border-border/40 bg-card/50 p-8 backdrop-blur-sm">
            <div className="mb-4 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  We aim to keep Docvia available and reliable, but we do not guarantee
                  uninterrupted or error-free service. Features may change, be updated, or
